    ...
    switch(method){
        case 'login':
            ...
            if (addressParts.length > 1) {
                sendReply('Address parts after "." not supported. Ignoring: ' + addressParts.slice(1).join('.'));
            }
            ...
            if(typeof global.getWallet(params.login) === "undefined")
            {
                sendReply(params.login + ' is not found on the list of registered addresses');
                return;
            }
